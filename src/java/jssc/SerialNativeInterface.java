 ...
 * @author scream3r
 */
public class SerialNativeInterface implements SerialInterface {
	...
	static {
		...
		if (loadLib) {
			...
			if (!versionBase.equals(versionNative)) {
				System.err.println("Warning! jSSC Java and Native versions mismatch (Java: " + versionBase
	...
	public native boolean setParams(long handle, int baudRate, int dataBits, int stopBits, int parity, boolean setRTS,
